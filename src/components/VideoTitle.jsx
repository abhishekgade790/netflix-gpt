  ...
  return (
    <div className="absolute w-2/3 top-[30%] md:top-[25%] left-0 px-6 sm:px-12 z-20 text-white text-left">
      ...
      <div className="flex w-screen flex-wrap gap-2 md:gap-4 mt-2 md:mt-8">
        <button className="bg-white text-black font-semibold text-sm md:text-lg px-3 md:px-4 py-1 sm:py-2.5 rounded hover:bg-gray-300 transition flex items-center gap-2">
          <FaPlay />
          Play
        </button>
