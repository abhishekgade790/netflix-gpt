...
const TrailerPlayer = ({ trailerKey, movieInfo }) => {
  ...
  return (
    <div className="relative max-w-5xl mx-auto mt-[20vh] overflow-hidden shadow-xl bg-black">
      {/* Video */}
      ...
      <div className="max-h-[300px] overflow-y-auto p-6 bg-black text-white space-y-3 rounded-b-2xl">
